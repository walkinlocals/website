...
import { WaitlistTextCta } from "@/components/waitlist-marketing-ctas";
        ...
        <div className={`${PAGE_CONTAINER} py-14 sm:py-20 lg:py-24`}>
          ...
          <div className="mt-12 grid gap-12 sm:grid-cols-2 sm:gap-10 lg:gap-16">
            <div>
              ...
              <div className="mt-6">
                <WaitlistTextCta role="Host" label="Become a Dublin Host →" />
              </div>
            </div>
            <div>
              ...
              <div className="mt-6">
                <WaitlistTextCta role="Guest" label="Join as a Backpacker →" />
              </div>
            </div>
          </div>
        </div>
