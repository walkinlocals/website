    ...
    <header id="site-navbar" className="sticky top-0 z-50 border-b border-slate-200 bg-white relative">
      <div className={`w-full ${SITE_GUTTER}`}>
        <nav className="flex min-w-0 items-center gap-2 py-3 sm:gap-4 sm:py-5 lg:py-6">
          <Link href="/" className="flex min-w-0 flex-1 items-center gap-2 overflow-hidden sm:flex-initial sm:gap-3">
            <span className={`${brandWordmark} truncate whitespace-nowrap leading-none`}>
              {BRAND_NAME}
            </span>
            <Image
              src="/images/logo.png"
          ...
          <div className="ml-auto flex shrink-0 items-center justify-end gap-2 sm:gap-3">
            <form
              ...
              className="hidden min-w-0 2xl:block 2xl:w-[min(100%,280px)]"
            >
            ...
            {isAuthed && profile ? (
              <Link href="/profile" className="shrink-0 2xl:hidden">
            ...
            {isAuthed && profile ? (
              <Link href="/profile" className="hidden shrink-0 2xl:block">
        ...
        <form onSubmit={handleSearchSubmit} className="pb-3 pt-0 2xl:hidden sm:pb-4">
          ...
          >
            {loading ? (
              ...
              <ul className="flex flex-col">
                ...
                {!loading && !isAuthed ? (
                  <li className="mt-1 border-t border-slate-200 pt-1 2xl:hidden">
                    <Link
                      href="/login"
                      onClick={() => setMenuOpen(false)}
                      className="block px-5 py-4 text-lg font-medium text-slate-700 hover:bg-[#002FA7]/5 hover:text-[#002FA7]"
