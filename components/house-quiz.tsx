...
type HouseQuizProps = {
  ...
  embedded?: boolean;
  /** Called when the user wants to leave the result screen and return to the quiz intro. */
  onExit?: () => void;
};

export default function HouseQuiz({ nextStep, embedded = false, onExit }: HouseQuizProps) {
  ...
  return (
    <div className={`space-y-12 border-t border-slate-200/80 pt-10 sm:pt-12 ${embedded ? "text-left" : ""}`}>
      ...
      <div className="space-y-3">
        ...
        <h3 className="font-sans text-3xl font-medium text-slate-950 sm:text-4xl lg:text-5xl">
          {result.title}
        </h3>
      ...
      <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-7 space-y-5">
          <p className="border-l-2 border-[#002FA7]/30 pl-5 font-sans text-xl italic leading-relaxed text-slate-950 sm:text-2xl sm:leading-relaxed">
            {result.personality}
          </p>
